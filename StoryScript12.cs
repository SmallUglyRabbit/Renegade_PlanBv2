...
{ 
	...
	public class StoryScript12 : MonoBehaviour
	{
		...
		{
			if (other.tag == "Player" && GlobalsScript.StoryFlagsArray[11] == false)
			{
				PlayerTalk.text = GlobalStringText.PlayerTalkStrings[11];
				ParasiteTalk.text = GlobalStringText.ParasiteTalkStrings[11]; 
				//	Player_RigidBody.constraints = RigidbodyConstraints2D.FreezePosition;//Freeze till dialog is done	
                GlobalsScript.StoryFlagsArray[11]=true;
