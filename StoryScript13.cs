...
{ 
	...
	public class StoryScript13 : MonoBehaviour
	{
		[SerializeField] 
		...
		void OnTriggerEnter2D(Collider2D other)
		{
			...
			{
				PlayerTalk.text = GlobalStringText.PlayerTalkStrings[12];
				ParasiteTalk.text = GlobalStringText.ParasiteTalkStrings[12];
		...
		private void ONDONE()
		{
			PlayerTalk.text = "Yes, OUR planet.";
			ParasiteTalk.text = "Funny"; 
