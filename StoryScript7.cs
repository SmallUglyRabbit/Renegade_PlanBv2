...
{ 
	...
	public class StoryScript7 : MonoBehaviour
	{
		[SerializeField] 
		...
		void OnTriggerEnter2D(Collider2D other)
		{
			...
			{
				PlayerTalk.text = GlobalStringText.PlayerTalkStrings[6];
				ParasiteTalk.text =  GlobalStringText.ParasiteTalkStrings[6];
		...
		{
			PlayerTalk.text = "Huh?";
			ParasiteTalk.text = "Do you remember the crash? I was in a tube meant for another body.";
