...
{ 
	...
	public class StoryScript21 : MonoBehaviour
	{
		[SerializeField] 
		...
		{
			if (other.tag == "Player" && GlobalsScript.StoryFlagsArray[20] == false)
			{
				PlayerTalk.text = GlobalStringText.PlayerTalkStrings[20];
				ParasiteTalk.text =  GlobalStringText.ParasiteTalkStrings[20];
                GlobalsScript.StoryFlagsArray[20] = true;
			}
		}
		private void ONDONE()
		{
			PlayerTalk.text = "This is not your body, I won't let you";
			ParasiteTalk.text = "Human, I have inhabited 1000's of bodies from 100's of worlds, you are no match for me."; 
