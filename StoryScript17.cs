...
{ 
	...
	public class StoryScript17 : MonoBehaviour
	{
		...
		{
			if (other.tag == "Player" && GlobalsScript.StoryFlagsArray[16] == false)
			{
				PlayerTalk.text = GlobalStringText.PlayerTalkStrings[16];  
				ParasiteTalk.text = GlobalStringText.ParasiteTalkStrings[16]; 
				GlobalsScript.StoryFlagsArray[16] = true; //Changes the first story flag to false.
