...
public class RandomEncounterScriptZone4 : MonoBehaviour //This is for the sewer maze ZONE 1.
{
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        if (other.tag == "Player")
        {
            ...
            if(RandomEncounterRoll == 98)
            {
                ...
                GlobalsScript.RandomEncounterCategory = 8;//Evil Doctor
            ...
            else if(RandomEncounterRoll == 3)
            {
                ...
                GlobalsScript.RandomEncounterCategory = 8; //Clean Up Crew 1
                GlobalsScript.lastposition.x = PlayerPosition.position.x;
            ...
            else if(RandomEncounterRoll == 30)
            {
                ...
                GlobalsScript.RandomEncounterCategory = 8; //Rat
                GameSaverScript.Save(); 
                GlobalsScript.lastposition.x = PlayerPosition.position.x;
            ...
            else if(RandomEncounterRoll == 77)
            {
                ...
                GlobalsScript.RandomEncounterCategory = 8; //Evil Nurse
                GlobalsScript.lastposition.x = PlayerPosition.position.x;
