...
{ 
	...
	public class StoryScript16 : MonoBehaviour
	{
		[SerializeField] 
		...
		{
			if (other.tag == "Player" && GlobalsScript.StoryFlagsArray[15] == false)
			{
				PlayerTalk.text = GlobalStringText.PlayerTalkStrings[15];
				ParasiteTalk.text = GlobalStringText.ParasiteTalkStrings[15];
		...
		private void ONDONE()
		{
			PlayerTalk.text = "What? This is murder! You can't do this.";
			ParasiteTalk.text = "Do you consider it murdering plants when you build your homes?"; 
