...
{ 
	...
	public class StoryScript10 : MonoBehaviour
	{
		...
		{
			if (other.tag == "Player" && GlobalsScript.StoryFlagsArray[9] == false)
			{
				PlayerTalk.text = GlobalStringText.PlayerTalkStrings[9];
				ParasiteTalk.text = GlobalStringText.ParasiteTalkStrings[9];
            GlobalsScript.StoryFlagsArray[9]=true;	 
			}
		}
		private void ONDONE()
		{
